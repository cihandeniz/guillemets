...
public class SpecTests
{
    static readonly HashSet<string> IGNORED_FIXTURES =
        [
            ...
            "10-errors/003-mismatched-block-depth",
            "10-errors/019-missing-blank-before-else",
            "10-errors/020-missing-blank-after-else",
            "10-errors/021-missing-blank-before-footer",
            "12-escaping/002-close-inside-block",
            "12-escaping/006-close-run-inside-deeper-block",
            "12-escaping/007-escaped-tilde",
            "11-whitespace/001-crlf",
            ...
            "14-scope-navigation/013-this-scope-only-skips-defined-variable",
        ];
