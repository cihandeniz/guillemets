...
internal static class Tokens
{
    ...
    public static OpenBlockToken OpenBlock(TokenContext context) => new(context.Position);
    public static CloseToken Close(TokenContext context) => new(context.Position);
    public static CloseBlockToken CloseBlock(TokenContext context) => new(context.Position);
    public static ColonToken Colon(TokenContext context) => new(context.Position);
